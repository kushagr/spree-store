...
ActiveRecord::Schema.define(version: 20140930094508) do
  ...
  create_table "spree_products_wishlists", id: false, force: true do |t|
    t.integer "product_id"
    t.integer "wishlist_id"
  end

  add_index "spree_products_wishlists", ["product_id"], name: "index_spree_products_wishlists_on_product_id", using: :btree
  add_index "spree_products_wishlists", ["wishlist_id"], name: "index_spree_products_wishlists_on_wishlist_id", using: :btree
